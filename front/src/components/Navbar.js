  ...
  const [nav, setNav] = useState(false)
    ...
    return ( 
      ...
      role="navigation"> 
        ...
        <div onClick={handleNav} className='cursor-pointer md:hidden text-white hover:text-red'>
        ...
        /> : <AiOutlineMenu size={20}/>}
          ...
          {/* { user && <p className='text-white text-base inline pr-4'>Hi {user.userName}!</p>} */}
